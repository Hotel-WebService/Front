            ...
            >
                ...
                {step === totalSteps && (
                    ...
                    >
                        ...
                        <Box mt={4} fontSize="md" color="gray.600" textAlign="left" alignSelf="start">
                            <Text><b>선택한 지역:</b> {dbAnswers.district}</Text>
                            <Text><b>성급:</b> {dbAnswers.star}</Text>
                            <Text><b>주차:</b> {dbAnswers.parking_lot}</Text>
                            <Text><b>인원:</b> {dbAnswers.capacity}</Text>
                            <Text><b>가격:</b> {dbAnswers.price}</Text>
                            <Text><b>체크인:</b> {dbAnswers.check_in}</Text>
                            <Text><b>테마:</b> {aiAnswers.theme}</Text>
                            <Text><b>분위기:</b> {aiAnswers.mood}</Text>
                            <Text><b>특별요구:</b> {aiAnswers.special}</Text>
                        </Box>
                        <Button
                            colorScheme="teal"
                            mt={8}
